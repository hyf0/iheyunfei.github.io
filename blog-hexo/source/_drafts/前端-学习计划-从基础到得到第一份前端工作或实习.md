...
1. 学习react至原理
    - 前提：
        - es6基础 - 把es6基础入门过一遍
    - 学习：
        - 教程：[~~react官方文档~~](https://react.docschina.org/docs/hello-world.html)
        - 视频：[~~React16.4开发简书项目从零基础入门到实战~~](https://coding.imooc.com/class/229.html)
        - 视频：[React服务器渲染原理解析与实践](https://coding.imooc.com/class/276.html)
            - 实现简书项目服务端渲染
...
<!-- - 教程：[vue-element-admin](https://panjiachen.github.io/vue-element-admin-site/zh/guide/)
            - 使用React重构这个项目
            - 这很重要，如果能形成一些文章，对于找工作很有帮助
-->
    - 考核
        - 2个react应用
        - 证明自己看过且看懂了react源码
